...
from src.embeddings import get_sentence_transformer_embeddings
...
if uploaded_files:
    ...
    if st.button("Process Documents"):
        ...
        embeddings = get_sentence_transformer_embeddings(doc_texts)
...
if question and st.button("Get Answer"):
    ...
    results = retrieve_relevant_chunks(question, get_sentence_transformer_embeddings, collection)
